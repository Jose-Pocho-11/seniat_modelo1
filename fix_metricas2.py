...
metricas_main = """    <!-- METRICS VIEW -->
    <main id="view-metrics" class="flex-1 bg-slate-50/50 p-4 lg:p-10 h-screen overflow-y-auto custom-scrollbar relative w-full">
        <div class="max-w-7xl mx-auto space-y-8">
            ...
            <!-- Gráfica Combinada -->
            <div class="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm mt-8">
                <h4 class="font-black text-lg text-slate-800 mb-6">Tendencia Global de Recaudación (Monto en Bs.)</h4>
...
final_html = re.sub(r'<main id="view-dashboard".*?</main>', metricas_main, index_html, flags=re.DOTALL)
final_html = final_html.replace('v=2.1', 'v=2.8')
